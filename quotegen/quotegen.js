var myData = [
  ...
  {
    "quote": "My heart and actions are utterly unclouded! They are all those of justice!",
    "bgcolor": "#5ce65c",
    "bgimg": 'http://pm1.narvii.com/5778/0780ff17035fbea83afa368f66947b3a8cd4e3bd_hq.jpg',
    "author": "Funny Valentine",
    "source":"JJBA Part 7: Steel Ball Run"
  },
  {
    "quote": "Your Stand is like your asshole: you can't go around showing it off to other people.",
    "bgcolor": "#0099ff",
...
function newQuote() {
  ...
  document.getElementById("author").innerHTML = myData[obj].author + ", " + myData[obj].source;
